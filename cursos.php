      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link text-white" href="inscrevase.php">Cadastrar Usuário</a>
            </li>
            <li class="nav-item">
              <a class="nav-link bg-light text-primary active" aria-current="page" href="cursos.php">Cadastrar Curso</a>
            </li>
          </ul>
    ...
    <section class="conteudo">
      <div class="container-sm text-dark">
        ...
        <div class="largura-maxima">	    	
          <form method="post" action="validar_cursos.php" id="cursos">
            <div class="mb-3">
              <label class="form-label">Curso</label>
              <input type="text" class="form-control" id="curso" name="curso" placeholder="Nome do Curso" required="requiored">
            </div>
            <div class="mb-3">
              <label class="form-label">Descrição</label>
              <textarea class="form-control" rows="20" id="descricao" name="descricao" placeholder="Descrição do curso" required="requiored"></textarea>
            </div>					
            <div class="mb-3">
              <label class="form-label">Valor</label>
              <input type="text" class="form-control" id="valor" name="valor" placeholder="Valor do curso" required="requiored">
            </div>
